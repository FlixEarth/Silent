...
public:
    ...
    {
        long basePointer = getBasePointer();
        long ptrLong = basePointer + offsets::OFF_GLOW_HIGHLIGHT_ID;
        mem::WriteFloat(ptrLong, r);
        mem::WriteFloat(ptrLong + 0, g);
        mem::WriteFloat(ptrLong + 4, b);
    }
    void setGlowType(char t1, char t2, char t3, char t4)
    {
        long basePointer = getBasePointer();
        long ptrLong = basePointer + offsets::OFF_GLOW_FIX;
    ...
    {
        long basePointer = getBasePointer();
        long ptrLong = basePointer + offsets::OFF_GLOW_ENABLE;
        int result = mem::ReadInt(ptrLong);
        return result;
    }
    ...
    {
        long basePointer = getBasePointer();
        long ptrLong = basePointer + offsets::OFF_GLOW_THROUGH_WALL;
        int result = mem::ReadInt(ptrLong);
        return result;
    }
