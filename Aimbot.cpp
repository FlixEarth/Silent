...
#define AIMBOT_CIRCLE_DISTANCE_2D 50
#define AIMBOT_DISTANCE_3D 150//(meter)
...
public:
    ...
    int findClosestEnemyIndex_TrainingArea()
    {
        ...
        for (size_t i = 0; i < 20000; i++) {
            ...
            mem::WriteInt(ent_base + offsets::OFF_GLOW_ENABLE, 1);
            mem::WriteInt(ent_base + offsets::OFF_GLOW_THROUGH_WALL, 2);
            char w_buf[4] = {101,101,46,90};
            mem::readbytearray(ent_base + offsets::OFF_GLOW_FIX, w_buf, 0);
            mem::WriteFloat(ent_base + offsets::OFF_GLOW_HIGHLIGHT_ID, FLT_MAX);
            mem::WriteFloat(ent_base + offsets::OFF_GLOW_HIGHLIGHT_ID + 0, FLT_MAX);
            mem::WriteFloat(ent_base + offsets::OFF_GLOW_HIGHLIGHT_ID + 4, FLT_MAX);
